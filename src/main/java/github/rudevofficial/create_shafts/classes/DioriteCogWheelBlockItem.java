...
public class DioriteCogWheelBlockItem extends CogwheelBlockItem
{
    public DioriteCogWheelBlockItem(CogWheelBlock block, Properties builder) {
        super(block, builder);
    }
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            if (!ICogWheel.isLargeCog(state)) {
                ...
                for (Direction dir : directions) {
                    ...
                    if (!DioriteCogWheelBlock.isValidCogwheelPosition(false, world, newPos, axis))
                        continue;
